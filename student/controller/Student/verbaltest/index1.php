...
<div class="clear" style="height:40px;"></div>
    ...
    <div id="sidebar" class="list-group"> <a href="index.php" class="list-group-item active"><i class="icon-dashboard"></i> Dashboard</a><a href="#users" class="list-group-item" data-toggle="collapse" data-parent="#sidebar"><i class="icon-group"></i> Faculty Management<span class="badge bg_danger">+</span></a>

        <div id="users" class="list-group subitem collapse in">	<a href="#" class="list-group-item"><i class="icon-caret-right"></i> Add Faculty</a><a href="#" class="list-group-item"><i class="icon-caret-right"></i>Upload Faculty </a><a href="#" class="list-group-item"><i class="icon-caret-right"></i> View Faculty</a>

        </div>	<a href="#articles" class="list-group-item" data-toggle="collapse" data-parent="#sidebar"><i class="icon-file-text"></i> Student Management<span class="badge bg_danger">+</span></a>

        <div id="articles" class="list-group subitem collapse">	<a href="#" class="list-group-item bg_warning"><i class="icon-caret-right"></i> Add Student</a><a href="#" class="list-group-item"><i class="icon-caret-right"></i> Upload Student</a>

      <a href="#" class="list-group-item"><i class="icon-caret-right"></i> View Student</a>  </div>
    </div>
</div>
      </div>-->
