...
if($_GET['action']=='delete'){
	...
	$rs=mysql_query("delete from test_tests where `test_id`='$_GET[test_id]'");
...
<fieldset>
<legend><font color="#330099" ><strong>View Tests</strong></font></legend>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	...
	while($row=mysql_fetch_array($rs)){
		...
		<tr class="odd gradeX">
			...
			<td><!--<a href="?id=update subcategory&action=edit&category=<?php echo $row['category_id']; ?>"><img src="../../image/edit.jpg" height="20" width="20" title="Edit"/></a> -->&nbsp;&nbsp;<a href="?id=view tests&action=delete&test_id=<?php echo $row['test_id']; ?>"><img src="../../image/delete.jpg" height="20" width="20" title="Delete" onclick="return confirm('Are You Sure to delete this entry?')"></a></td>
		</tr>		
	<?php }
	?>
