...
$rs4= "SELECT * from `online_test` where (test_id='".$test_name."' and CAT_NAME='".$cat_name."' and  STATUS='ACTIVE')  order by id"; 
...
$findque=mysql_query("select * from `temp_test_result` where test_id='$test_name' AND candidate='$user' AND instance='$instance1' AND question_id='$rows[id]'");
