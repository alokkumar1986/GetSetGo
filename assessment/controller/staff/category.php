...
if(isset($_POST['submitted']))
{
   if($fgmembersite->Addcategory())
   {
        ...
        $fgmembersite->HandleDBError("Subject/Category Added Successfully");
   }
}
...
<legend><font color="#330099" ><strong>Add Subject/Category</strong></font></legend>

<div><span class='error'><?php echo $fgmembersite->GetErrorMessage(); ?></span></div>
<input type='hidden' name='submitted' id='submitted' value='1' />
<input type="text" name="name" placeholder="Subject/Category Name"/>&nbsp;&nbsp;&nbsp;
...
<p><select name="category" class="validate[required] text-input" style="color: grey;width:98% !important;">
					...
					<option value="<?php echo $rs1['category_id']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rs['name']; ?>-><?php echo $rs1['name']; ?></option>	
					...
					<option value="<?php echo $rs11['category_id']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rs['name']; ?>-><?php echo $rs1['name']; ?>-><?php echo $rs11['name']; ?></option>	
					...
					<option value="<?php echo $rs111['category_id']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rs['name']; ?>-><?php echo $rs1['name']; ?>-><?php echo $rs11['name']; ?>-><?php echo $rs111['name']; ?></option>	
					<?php } } }
					 } ?>
                   </select>
                   </p>
...
<br/>
    <input type='submit' class="btn btn-success" id="button1" name='Submit' value='Submit' /> &nbsp;&nbsp;&nbsp;<!--<a href="?id=upload category" class="btn btn-danger" style="float: right;margin-left:10px;margin-right:10px;">Upload Subject/Category CSV</a>-->&nbsp;&nbsp;&nbsp;<a href="?id=view category" class="btn btn-info" style="float: right;">View Subject/Category </a>
</fieldset>
</form>
