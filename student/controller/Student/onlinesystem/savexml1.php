...
?>
&nbsp; &nbsp;
<input name="" id="" type="hidden" value="<?php echo $rows['id']; ?>" /><?php //echo $rows['question']; ?> <?php if($ansresult=='1' ||  $ansresult=='2' || $ansresult=='3' || $ansresult=='4' || $ansresult=='5'){ ?> <span id="A<?php echo $rows['id']; ?>" style="color:#009900;"><font size=2.0em>Answered and Saved</font></span> <?php } else { ?><span id="A<?php echo $rows['id']; ?>" style="color:#FF0000;"><font size=2.0em>Not Answered</font></span> <?php } ?><br />
<br />
</div>
<?php
$i++;
