...
?>
<table border="1"><tr style="border-bottom: 1px solid #000;background: #000;color: #ffffff"><td align="center" colspan='7'><h4>Technical Interview Report (Date : <?php echo $dateofinterview; ?>)<br/><?php if($college!=''){ ?>College : <?php echo $college; ?>,<?php } ?> <?php if($branch!=''){ ?>Branch : <?php echo $branch; ?><?php } ?></h4></td></tr>
