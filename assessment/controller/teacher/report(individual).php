...
<fieldset>
<legend><font color="#330099" ><strong><?php echo $_POST['test']; ?> Report for <?php echo $_POST['s']; ?>-<?php echo  $yop=str_replace("multiselect-all,",'',implode(",",$_POST['yop'])); ?> </strong></font></legend>
...
<tbody>
<?php $rs1=mysql_query("select * from `student_data` where (`COLLEGE`='".$_POST['shortname']."' and `COURSE_YOP` in ($yop) and REG_NO='".$_POST['s']."') ");
$i=1;
