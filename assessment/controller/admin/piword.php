...
while($row=mysql_fetch_array($rs)){
	...
	if($count==1){
      ...
      <tr>
        ...
        <td class="value last"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['CLARITY']*74; ?>" height="16" /><?php echo (float)$row1['CLARITY']; ?>
				</td>
      </tr>
      <tr>
        <td class="first">Articulation- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['ARTICULATION']*74; ?>" height="16" /><?php echo (float)$row1['ARTICULATION']; ?></td>
      </tr>
      <tr>
        <td class="first">Usage- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['USAGES']*74; ?>" height="16" /><?php echo (float)$row1['USAGES']; ?></td>
      </tr>
      <tr>
        <td class="first">Confidence- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['CONFIDENCE']*74; ?>" height="16" /><?php echo (float)$row1['CONFIDENCE']; ?></td>
      </tr>
		<tr>
        <td class="first">Body Language- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['BODY_LANG']*74; ?>" height="16" /><?php echo (float)$row1['BODY_LANG']; ?></td>
      </tr>
			<tr>
        <td class="first">Listening- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['LISTENING']*74; ?>" height="16" /><?php echo (float)$row1['LISTENING']; ?></td>
      </tr>
			<tr>
        <td class="first">Appearance- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['APPEARANCE']*74; ?>" height="16" /><?php echo $row1['APPEARANCE']; ?></td>
      </tr>
			<tr>
        <td class="first">Mannerism- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['MANNERS']*74; ?>" height="16" /><?php echo $row1['MANNERS']; ?></td>
      </tr>
			<tr>
        <td class="first">Overall Rating- </td>
        <td class="value"><img src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/new/GetSetGo/assessment/controller/admin/bar1.png" alt="" width="<?php echo $row1['RATING']*74; ?>" height="16" /><?php echo $row1['RATING']; ?></td>
      </tr>
    ...
    <ul>    
		<?php $count=1;
						...
						foreach($choice as $a) {
							...
							echo "<li> ".$a."</li>"; 
						$count++; } ?>
						<li><?php echo $row1['OTHER_FEEDBACK']; ?> </li>
						</ul>
