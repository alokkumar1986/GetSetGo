...
$db = new Database();  
$db->connect(); 
//echo "select distinct(instance) from `test_status` where test_id='".$test_name."' AND candidate='".$_SESSION['regno_of_user']."' AND status='finish'";
...
//echo "select * from `test_timer2` where test_id='".$test_name."' and category='".$cat_name."'  AND candidate='".$_SESSION['regno_of_user']."' and instance='".$instance1."' ";
