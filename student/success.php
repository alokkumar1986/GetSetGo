<?PHP
$path="http://localhost/induseducation/";
?>
        	...
        	<div id="login-signup-container" class="container">
                <div id="login-Signup-box">
                	...
                	<div id="login-box-inner" style="text-align: center;padding-top:100px;">
                        ...
                        <span style="font-size:35px; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;text-align: center;">Thanks for Registering!</span>
                        <hr>
                        
                        
                        <div class="form-horizontal" style="text-align: center;">

<p style="padding:10px;">Your confirmation email is on its way. Please click the link in the 
