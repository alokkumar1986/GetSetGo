...
*/
(function(b){b.fn.checknet=function(a){function c(){window.checknet.windowIsActive=document.hidden||document.mozHidden||document.webkitHidden||document.msHidden?!1:!0}function d(a){window.checknet.windowIsActive&&b.ajax({url:a,cache:!1,type:"HEAD"}).done(function(){window.checknet.conIsActive=!0}).fail(function(){window.checknet.conIsActive=!1}).always(function(){window.checknet.conIsActive?(b("#netWarn").length&&b("#netWarn").fadeOut("fast",function(){b(this).remove()}),b(".tempDisabled").removeAttr("disabled").removeClass("tempDisabled"),b('input[id="print"]').attr("disabled","disabled").addClass("tempDisabled")):
(b("#netWarn").length||(b("#result").prepend('<p id="netWarn">'+window.checknet.config.warnMsg+"</p>"),b("#netWarn").fadeIn("fast")),b('input[id="submit"]').attr("disabled","disabled").addClass("tempDisabled"),b('input[id="print"]').removeAttr("disabled").removeClass("tempDisabled"),b('.review').attr("disabled","disabled").addClass("tempDisabled"))});setTimeout(function(){d(window.checknet.config.checkURL)},window.checknet.config.checkInterval)}a=a||{};a.checkURL=a.checkURL||window.location.href;a.checkInterval=a.checkInterval||5E3;a.warnMsg=a.msg||"No Internet connection detected or Connection to the server is disconnected , disabled features will be re-enabled when a connection is detected. ";
