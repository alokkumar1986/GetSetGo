            ...
            function memory3(operator) {
                document.getElementById("zadatak3").focus();
                if (operator == 1) {        // MS
                    document.getElementById("memorija3").value = document.getElementById("rezultat3").value
                }
                else if (operator == 2)    {    // MR
                    var memorija = document.getElementById("memorija3").value;
                    if (memorija==0 || slovo(memorija.charAt(0)))
                    {
                        // alert("yes");
                        memorija = ""
                    };
                    document.getElementById("zadatak3").value += memorija
                }
                else if (operator == 3) {

                    if (document.getElementById("zadatak3").value == "") {
                        document.getElementById("rezultat3").value = "";
                    }
                    else {
                        document.getElementById("zadatak3").value = "";
                    }
                }
            }
            ...
            function display(noviznak) {
                ...
                {document.getElementById("rezultat3").select()}

            }


            function dodajBroj3(noviznak) {
                //   alert("in value "+document.getElementById("racunalo").document.getElementById("zadatak").focus());
                document.getElementById("zadatak3").focus();
                document.getElementById("zadatak3").value += noviznak
            }


            function izracunaj3(zarez) {
                var pitanje = "";
                var mem = 0;
                if (zarez >= 1) {
                    if (document.getElementById("zadatak3").value == "") {
                        broj = document.getElementById("rezultat3").value;
                    }
                    else {

                        broj = document.getElementById("zadatak3").value;

                        if (ubacirezultat(broj.charAt(0))) {
                            broj = document.getElementById("rezultat3").value + broj;
                        }
                    }
                }
                ...
                document.getElementById("oldrezultat3").value = pitanje;
            ...
            function matematika3(zarez, rjesenje) {
                with (Math)
                {
                    ...
                    if (zarez == 2) {
                        ...
                        if (document.getElementById("stupnjevi13").checked) {rjesenje = (rjesenje * 180) / PI}
                    }
                    else if (zarez >= 14 && zarez <= 16) {

                        if (document.getElementById("stupnjevi13").checked)
            ...
            function zaokruzi3(ebroj) {


                decimala=parseFloat(document.getElementById('izaZareza3').options[document.getElementById('izaZareza3').selectedIndex].value);
                ...
                document.getElementById("rezultat3").value = odgovor;
            }


            function deczarez3(novibroj) {
                tocka = 0;
                eksp = 0;
