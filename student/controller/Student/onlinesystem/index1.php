...
$query="select * from `online_test` where `test_id`='$test1' order by id";
...
if($tids!='')
{
$db->select('questions','id,question,subject_id,ans1,ans2,ans3,ans4,ans5,corans',"id='$tids'",null,null,null);  
$rows = $db->get_name();
$ans1.=$rows['corans'];
if($rows['corans']){
$ans1.=",";
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">	
    ...
    <meta name="find_proxy.js"><meta name="get_html_text.js"><meta name="global_constants.js"><meta name="name_injection_builder.js">		<meta name="number_injection_builder.js"><meta name="string_finder.js"></head>
<style>
...
<?php $sqlquery="select * from `online_test` where `test_id`='$test1' order by id";
...
?><img <?php if($pic!=''){ ?>src="../uploads/<?php echo $pic; ?>" <?php }else { ?>src="../../example/profile.jpg" <?php } ?> alt="User Photo" width="150" height="150" style="border:1px solid #ddd;border-radius:4px;margin-right:3px;padding:4px;"/>
				...
				<p style="font-size:16px;color:#000;font-weight:bold;">Welcome to Indus Education Online Test </p>
				 ...
				 <p>&nbsp;</p>
					...
					<?php $sql=mysql_query("select * from `test_setting` where test_id='".$test1."' and for_college='".$_SESSION['college']."'");
if($cnt=mysql_fetch_array($sql)){ 
$rowdur=$cnt['duration']; } ?>	
<p align="center"> <a href="#" id="readylink" class="btn4" alt=""  <?php if($rowdur=='Combined Section Duration'){ ?>onClick="return start();" <?php } if($rowdur=='Each Section Duration'){ ?> onClick="return start1();" <?php } ?> style="background-color:#CC3300 !important;"><font size="5">I am ready to begin</font></a></p>
 </div>
		</div>		
	</div>	
<div id="header" style="height:30px;position: fixed;bottom: 0;"></div>
