...
<legend><font color="#330099" ><strong>Feedback Setting</strong></font></legend>
...
<p>            
 ...
 <!-- <p><input name="venue" id="venue" type="text" placeholder="Venue Details" class="input-large" required /></p> 
  <p><input name="company" id="company" type="text" placeholder="Company Details" class="input-large" required/></p> -->  
    ...
    <input type='submit' class="btn btn-success" id="button1" name='Submit' value='Submit' /> &nbsp;&nbsp;&nbsp;<a href="?id=view feedback setting" class="btn btn-danger" style="float: right;margin-left:10px;margin-right:10px;">View All Feedback  Setting</a>&nbsp;&nbsp;&nbsp;<!--<a href="?id=create test" class="btn btn-info" style="float: right;">Create Test</a> -->
</fieldset>
</form>
</div>
