...
<form id='changepwd' action='' method='get' enctype="multipart/form-data">

<fieldset style="float:center;" >
<legend><font color="#330099" ><strong>Email Checking</strong></font></legend>
<div><span class='error'><?php echo $fgmembersite->GetErrorMessage(); ?></span></div>
<input type='hidden' name='submitted' id='submitted' value='1'/>
<input type='hidden' name='id' id='submitted' value='student info'/>
   ...
   <br />
<br/>
 <p align="left">   <input type='button' class="btn btn-danger" name='Submit' value='Find Students' onclick="submitForm('?id=student info')" />  </p>
</fieldset>
</form>
</div>
