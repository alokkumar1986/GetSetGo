...
?>
      ...
      <title>Combine Interview Report</title>
...
<legend><font color="#330099" ><strong>Combine Interview Report Generation</strong></font></legend>
...
<?php $sql=mysql_query("select Distinct(INTERVIEWER) from tipi");
while($rs=mysql_fetch_array($sql)){ ?>
...
<?php	
   ...
   <br />
<br/>
 <p align="left">   <input type='button' class="btn btn-danger" name='Submit' value='Generate EXCEL' onclick="submitForm('combineexcel.php')" /> <!-- <input type='button' class="btn btn-success" name='Submit' value='Generate PDF' onclick="submitForm('pipdf.php')" /> -->
 <input type='button' class="btn btn-info" name='Submit' value='Generate Word' onclick="submitForm('combineword.php')" /></p>
</fieldset>
</form>
</div>
