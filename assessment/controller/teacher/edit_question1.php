...
$id=$_REQUEST['qid'];
       $sql_select="SELECT * FROM `test_question_true_false` where question_id='$id'";
...
<table border="0" width="100%" id="table2" style="border-collapse: collapse" bordercolor="#8FCBF8" bgcolor="#FFFFFF" cellspacing="5" cellpadding="5" align="center">
  ...
  <div class="panel-heading">Question<font color="#B81900">*</font></div>
				<textarea cols="30" id="summernote" name="summernote" rows="5" ><?php echo $row_select['question']; ?></textarea>
			</div>
</td>
			</tr>
            <tr>
  ...
  <div class="panel-heading">Answer Choice 1 <b><font color="#B81900">*</font></b></div>
			<textarea cols="10"  name="option_1" id="option_1" rows="5"><?php echo $row_select['choice1']; ?></textarea></div>
	<div class="panel panel-primary">
  <div class="panel-heading">Answer Choice 2 <b><font color="#B81900">*</font></b></div>
			<textarea cols="10"  name="option_2" id="option_2" rows="5" ><?php echo $row_select['choice2']; ?></textarea></div>
  ...
  <div class="panel-heading">Explanation</div>
            				<textarea cols="50" id="summernote1" name="summernote1" rows="5" style="width:400;height:50"><?php echo $row_select['explanation']; ?></textarea></div>
