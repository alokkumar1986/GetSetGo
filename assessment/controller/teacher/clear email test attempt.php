...
$sql="delete from `verbaltest_result` where (regd_no='$_POST[s]')";
$rs=mysql_query($sql);
$sql1="delete from `verbaltest_eval` where (regd_no='$_POST[s]')";
...
$sql4="delete from `test_timer2` where (candidate='$_POST[s]' and test_id='$_POST[test]' and instance in ($instance1))";
...
$("#s").autocomplete("../staff/data1.php");
...
<legend><font color="#330099" ><strong>Clear Email Test Attempt(Individual)</strong></font></legend>
<?php if($_SESSION['msg']!=''){ ?><div class="alert alert-danger alert-dismissable">
  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
   <?php echo "Email Test Attempt for ".$_POST[s]." has been cleared."; ?> </div> <?php } ?>
