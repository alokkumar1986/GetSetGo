            ...
            function memory2(operator) {
                document.getElementById("zadatak2").focus();
                if (operator == 1) {        // MS
                    document.getElementById("memorija2").value = document.getElementById("rezultat2").value
                }
                else if (operator == 2)    {    // MR
                    var memorija = document.getElementById("memorija2").value;
                    if (memorija==0 || slovo(memorija.charAt(0)))
                    {
                        // alert("yes");
                        memorija = ""
                    };
                    document.getElementById("zadatak2").value += memorija
                }
                else if (operator == 3) {

                    if (document.getElementById("zadatak2").value == "") {
                        document.getElementById("rezultat2").value = "";
                    }
                    else {
            ...
            function display2(noviznak) {
                if (noviznak=="")
                {document.getElementById("zadatak2").focus()}
                else
                {document.getElementById("rezultat2").select()}

            }


            function dodajBroj2(noviznak) {
                //   alert("in value "+document.getElementById("racunalo").document.getElementById("zadatak").focus());
                document.getElementById("zadatak2").focus();
                document.getElementById("zadatak2").value += noviznak
            }


            function izracunaj2(zarez) {
                var pitanje = "";
                var mem = 0;
                if (zarez >= 1) {
                    if (document.getElementById("zadatak2").value == "") {
                        broj = document.getElementById("rezultat2").value;
                    }
                    else {

                        broj = document.getElementById("zadatak2").value;

                        if (ubacirezultat(broj.charAt(0))) {
                            broj = document.getElementById("rezultat2").value + broj;
                        }
                    }
                }
                ...
                document.getElementById("oldrezultat2").value = pitanje;
            ...
            function matematika2(zarez, rjesenje) {
                with (Math)
                {
                    ...
                    if (zarez == 2) {
                        ...
                        if (document.getElementById("stupnjevi12").checked) {rjesenje = (rjesenje * 180) / PI}
                    }
                    else if (zarez >= 14 && zarez <= 16) {

                        if (document.getElementById("stupnjevi12").checked)
            ...
            function zaokruzi2(ebroj) {


                decimala=parseFloat(document.getElementById('izaZareza2').options[document.getElementById('izaZareza2').selectedIndex].value);
                ...
                document.getElementById("rezultat2").value = odgovor;
            }


            function deczarez2(novibroj) {
                tocka = 0;
                eksp = 0;
