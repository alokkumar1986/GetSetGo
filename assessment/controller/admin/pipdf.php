...
?>
<table border="1"><tr style="border-bottom: 1px solid #000;background: #000;color: #ffffff"><td align="center" colspan='10'><h4>Personal Interview Report (Date : <?php echo $dateofinterview; ?>)<br/><?php if($college!=''){ ?>College : <?php echo $college; ?>,<?php } ?> </h4></td></tr>
