...
<div class="container">
 ...
 <div class="row" style="padding-left:25px;padding-right:15px;">
      ...
      <div class="col-xs-6 col-sm-6 col-md-6" style="padding:20px;text-align: center" >
        ...
        <a href="">Profile</a> | <a href="">Change Password</a> | <a href="../logout.php">Logout</a>
            </div>
			 </div><!--Header Row End-->
			</div>
			</nav>
			<div class="clear" style="padding:80px;"></div>
			<div class="row">
...
<div class="panel panel-primary"> <div class="panel-heading"> </div>
	<table class="table" >
	<tr><td>
	<center>You have successfully submitted .<br/><br/>
    To protect your privacy, it's important that you logout after you finish each session.</center>
