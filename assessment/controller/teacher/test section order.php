...
<div>
<form id='changepwd' action='?id=order section' method='post' enctype="multipart/form-data">

<fieldset style="float:center;" >
<legend><font color="#330099" ><strong>Choose Test</strong></font></legend>
...
<p><select name="test_id" id="test" style="color: grey;width:30% !important;" onchange="">
