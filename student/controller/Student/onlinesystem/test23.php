...
<?php } 
if($calculator=='Yes'){  ?>
<script type='text/javascript' src='calculator/calcu1.js'></script>
<script type='text/javascript' src='calculator/calcu2.js'></script>
<script type='text/javascript' src='calculator/calcu3.js'></script>
<script type='text/javascript' src='calculator/calcu4.js'></script>
<link rel="stylesheet" href="calculator/calcu.css" />
<?php }
 ?>
...
<input type="hidden" name="timer" id="timer" value="00:00:00" />			  
				...
				<tr>
				<td  rowspan="2"  valign="top" style="background:#E4EDF7;;width:249px;color:#000;">
				<p></p>
...
<center>
<div style="margin:5px auto;background:#E4EDF7;">
<?php
if($j==1){
 if($calculator=="Yes"){  include("calculator/calculator1.htm"); } if($calculator=="No"){ } }
 if($j==2){
 if($calculator=="Yes"){  include("calculator/calculator2.htm"); } if($calculator=="No"){ } }
if($j==3){
 if($calculator=="Yes"){  include("calculator/calculator3.htm"); } if($calculator=="No"){ } }
 if($j==4){
 if($calculator=="Yes"){  include("calculator/calculator4.htm"); } if($calculator=="No"){ } }
