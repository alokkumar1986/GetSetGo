...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <meta charset="utf-8">
    <title>Assessment Email Checker Control</title>
                ...
                <a class="menuitem submenuheader" href="">Interview</a>
                 <div class="submenu">
                    ...
                    <!--<li><a href="search.php"> Interview</a></li>-->
										...
										<a class="menuitem submenuheader" href="">Email Writting</a>
                 <div class="submenu">
                    <ul>
                    <li><a href="?id=check emailpaper"> Check (Email Marking)</a></li>
										<li><a href="?id=report"> Dowload Report</a></li>
                 ...
                 <div class="submenu">
                    <ul>
                    <li><a href="?id=category">Subject/Category</a></li>
                    <li><a href="?id=question">Questions</a></li>
                    <li><a href="?id=test">Tests</a></li>
                    <li><a href="?id=setting">Settings</a></li>
                    </ul>
                </div>  -->
                <!--
