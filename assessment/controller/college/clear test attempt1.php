...
$sql="delete from `temp_test_result` where (candidate='$res[NAME]' and test_id='$_POST[test]')";
$rs=mysql_query($sql);
$sql1="delete from `test_status` where (candidate='$res[NAME]' and test_id='$_POST[test]')";
...
<?php if($_SESSION['msg']!=''){ ?><div class="alert alert-danger alert-dismissable">
  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
   <?php echo "Test Attempt for ".$_POST[s]." has been cleared."; ?> </div> <?php } ?>
   <p>
