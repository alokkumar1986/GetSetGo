...
<td width="75%"> <input type="text" name="reg_no" placeholder="Reg No." value="<?php echo $row['REG_NO']; ?>" /></td></tr>
   <tr><td>
...
<tr><td><strong>Email</strong>:</td><td> <input type="text" name="email" placeholder="Email" value="<?php echo $row['EMAIL_ID']; ?>" /></td></tr>
...
<tr><td><strong>College</strong>:</td><td> <input type="text" name="college" placeholder="College" value="<?php echo $row['COLLEGE_FULLNAME']; ?>" /></td></tr>
<tr><td><strong>Branch</strong>:</td><td> <input type="text" name="branch" placeholder="Branch" value="<?php echo $row['BRANCH']; ?>"  /></td></tr>
<tr><td><strong>Year Of Passing Out</strong>:</td><td> <input type="text" name="yop" placeholder="Year Of Passing Out" value="<?php echo $row['COURSE_YOP']; ?>" /></td></tr>
<tr><td colspan="2">
<p>
</p></td></tr>
<tr>
