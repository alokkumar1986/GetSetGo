...
/* ------------------------------------------------------------------------------------
	   ...
	   function testsetting(){
		...
		$qry="INSERT INTO `test_setting` (`test_id`, `start_date`, `end_date`, `for_college`, `for_yop`, `duration`, `calculator`,`instance`) VALUES ('".$formvars['test']."', '".$formvars['sdate']."', '".$formvars['edate']."', '".$formvars['college']."', '".$yop."', '".$formvars['sectionduration']."', '".$formvars['calculator']."', '".$formvars['instance']."')";
		if(!mysql_query( $qry ,$this->connection))
        {
            $this->HandleDBError("Error in Inserting Data.. \nquery:$qry2");
            return false;
		...
		if($count122<='0'){
		$qry12222="INSERT INTO `test_setting` (`test_id`, `start_date`, `end_date`, `for_college`, `for_yop`, `duration`, `calculator`,`instance`) VALUES ('".$formvars['test']."', '".$formvars['sdate']."', '".$formvars['edate']."', '".$formvars['college']."', '".$yop."', '".$formvars['sectionduration']."', '".$formvars['calculator']."', '".$formvars['instance']."')";
