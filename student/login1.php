...
<meta name="viewport" content="width=device-width, initial-scale=1.0"> 
   <meta http-equiv="X-UA-Compatible" content="IE=edge"> 
    <meta charset="utf-8">
    <title>Assessment Login Student</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<!--    <script type='text/javascript' src='<?php echo $path; ?>javascript/gen_validatorv31.js'></script> -->
    ...
    <div style="background-color: #306bcf;border: 0px solid #000;width:380px;margin: auto;border-radius:7px;box-shadow: 10px 10px 5px #888888;">
        ...
        <div id="login-wrapera" style="width:350px;padding:20px;margin: auto;">
            <form id="FormID" class="form login-form" action='<?php echo $fgmembersite->GetSelfScript(); ?>' name='login' method="post" autocomplete="off" style="width:290px;margin: auto;" onSubmit="return jQuery(this).validationEngine('validate');">
             <h2 style="color: #fff;text-align: center;">Student Login</h2>
                 
                <div class="body">
                <p align="center"><img src="<?php echo $path; ?>images/Students-icon.png" style="margin-top: -20px;"/>
...
<div class="footer" style="width:200px;margin:10px auto;">
                    <label class="checkbox inline">
                        <b>Don't have an account yet?</b>
                    </label>
 <br />
             <p align='center' style="margin-bottom:40px;"><a href="#"  class="btn btn-primary" style="text-align:center"><strong>Sign Up Now</strong></a></p>
</div>
<!-- position: fixed;bottom: 0; -->
<div id="wrapper" style="height:35px;background-color: #306bcf;border-top:2px solid #000;box-shadow:0px 2px 2px 2px #888888;">
 <div id="footer1"> 
