            ...
            function memory4(operator) {
                document.getElementById("zadatak4").focus();
                if (operator == 1) {        // MS
                    document.getElementById("memorija4").value = document.getElementById("rezultat4").value
                }
                else if (operator == 2)    {    // MR
                    var memorija = document.getElementById("memorija4").value;
                    if (memorija==0 || slovo(memorija.charAt(0)))
                    {
                        // alert("yes");
                        memorija = ""
                    };
                    document.getElementById("zadatak4").value += memorija
                }
                else if (operator == 3) {

                    if (document.getElementById("zadatak4").value == "") {
                        document.getElementById("rezultat4").value = "";
                    }
                    else {
                        document.getElementById("zadatak4").value = "";
                    }
                }
            }


            function display4(noviznak) {
                if (noviznak=="")
                {document.getElementById("zadatak4").focus()}
                else
                {document.getElementById("rezultat4").select()}

            }


            function dodajBroj4(noviznak) {
                //   alert("in value "+document.getElementById("racunalo").document.getElementById("zadatak").focus());
                document.getElementById("zadatak4").focus();
                document.getElementById("zadatak4").value += noviznak
            }


            function izracunaj4(zarez) {
                var pitanje = "";
                var mem = 0;
                if (zarez >= 1) {
                    if (document.getElementById("zadatak4").value == "") {
                        broj = document.getElementById("rezultat4").value;
                    }
                    else {

                        broj = document.getElementById("zadatak4").value;

                        if (ubacirezultat(broj.charAt(0))) {
                            broj = document.getElementById("rezultat4").value + broj;
                        }
                    }
                }
                ...
                document.getElementById("oldrezultat4").value = pitanje;
            ...
            function matematika4(zarez, rjesenje) {
                with (Math)
                {
                    ...
                    if (zarez == 2) {
                        ...
                        if (document.getElementById("stupnjevi14").checked) {rjesenje = (rjesenje * 180) / PI}
                    }
                    else if (zarez >= 14 && zarez <= 16) {

                        if (document.getElementById("stupnjevi14").checked)
            ...
            function zaokruzi4(ebroj) {


                decimala=parseFloat(document.getElementById('izaZareza4').options[document.getElementById('izaZareza4').selectedIndex].value);
                ...
                document.getElementById("rezultat4").value = odgovor;
            }


            function deczarez4(novibroj) {
                tocka = 0;
                eksp = 0;
