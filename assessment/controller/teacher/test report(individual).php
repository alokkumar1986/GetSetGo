...
<fieldset>
<legend><font color="#330099" ><strong>Test Report (Individual)</strong></font></legend>
 <p>
...
<br/>
    <input type='button' class="btn btn-success" id="button1" name='Submit' value='See Report Now' onclick="submitForm1('?id=report(individual)')" />
