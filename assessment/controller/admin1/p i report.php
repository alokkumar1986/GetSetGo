...
<?php	
   ...
   <br />
<br/>
 <p align="left">   <input type='button' class="btn btn-danger" name='Submit' value='Generate EXCEL' onclick="submitForm('piexcel.php')" />  <input type='button' class="btn btn-success" name='Submit' value='Generate PDF' onclick="submitForm('pipdf.php')" /> </p>
</fieldset>
</form>
</div>
