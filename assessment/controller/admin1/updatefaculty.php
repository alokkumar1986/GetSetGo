...
<tr><td>First Name: </td><td><input type="text" name="fname" placeholder="Firstname" value="<?php echo $fname; ?>"/></td></tr>
...
<tr><td>Interview Type:</td><td> <select name="typeinteviewer" style="width:206px;color:grey"><option value="">Interviewer Type</option><option value="PI" <?php if($row['actingrole']=='PI'){ ?> selected="selected" <?php } ?>>PI</option><option value="TI" <?php if($row['actingrole']=='TI'){ ?> selected="selected" <?php } ?>>TI</option><option value="BOTH" <?php if($row['actingrole']=='BOTH'){ ?> selected="selected" <?php } ?>>BOTH</option></select></td></tr>
<tr><td>
<p>
</p></td></tr>
<tr><td>
