...
<p><select name="college" id="college" class="validate[required] text-input" style="color: grey;width:98% !important;">
   ...
   <input type="text" name="date"  id="date2" placeholder="Date Of Interview" style="margin-top: 7px;" requred/>
<br/><br/>
...
<?php	
   ...
   <br />
<br/>
 <p align="left">   <input type='button' class="btn btn-danger" name='Submit' value='Generate EXCEL' onclick="submitForm('techexcel.php')" />  <input type='button' class="btn btn-success" name='Submit' value='Generate PDF' onclick="submitForm('techpdf.php')" /> <input type='button' class="btn btn-info" name='Submit' value='Generate Word' onclick="submitForm('techword.php')" /></p>
</fieldset>
</form>
</div>
