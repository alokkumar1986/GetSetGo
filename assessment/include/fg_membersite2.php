...
/* ------------------------------------------------------------------------------------
	...
	/* ------------------------------------------------------------------------------------
      ...
      if(!mysql_query( $qry ,$this->connection))
		...
		$qry2="INSERT INTO `admin`.`test_section_setting` (`test_id`, `section`, `eachquestionmark`, `eachwronganswer`, `time`) VALUES ('".$formvars['test']."', '".$section ."', '".$mark_of_each_question."', '".$negative_marking_of_each_wrong_answer."', '".$duration."')";
...
/* ------------------------------------------------------------------------------------
	   ...
	   function testsetting(){
		...
		$qry="INSERT INTO `test_setting` (`test_id`, `start_date`, `end_date`, `for_college`, `for_yop`, `duration`, `calculator`) VALUES ('".$formvars['test']."', '".$formvars['sdate']."', '".$formvars['edate']."', '".$formvars['college']."', '".$yop."', '".$formvars['sectionduration']."', '".$formvars['calculator']."')";
		if(!mysql_query( $qry ,$this->connection))
        {
            $this->HandleDBError("Error in Inserting Data.. \nquery:$qry2");
            return false;
