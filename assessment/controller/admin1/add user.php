...
<select name="typeinteviewer" id="more" style="width:206px; color:grey" ><option value="">User Type</option><option value="staff">Staff</option><option value="teacher">Teacher</option><option value="college">College</option><option value="admin">Administartor</option></select>

<select name="staff" id='staff' style="width:206px; color:grey;"><option value="" selected="selected">Interviewer Type</option><option value="PI">PI</option><option value="TI">TI</option><option value="BOTH">BOTH</option></select>
